(function () {
    ...
    var CircleCenterSplit = [
        {"left":{"url":"../addons/ytao_lipstick/static/img/CircleCenter_1_split_left.png","w":"238","h":"407","rs":Math.PI*2},
         "right":{"url":"../addons/ytao_lipstick/static/img/CircleCenter_1_split_right.png","w":"230","h":"407","cutx":"26","rs":Math.PI*2}},
        {"left":{"url":"../addons/ytao_lipstick/static/img/CircleCenter_2_split_left.png","w":"238","h":"407","rs":Math.PI*2},
         "right":{"url":"../addons/ytao_lipstick/static/img/CircleCenter_2_split_right.png","w":"230","h":"407","cutx":"26","rs":Math.PI*2}},
        {"left":{"url":"../addons/ytao_lipstick/static/img/CircleCenter_3_split_left.png","w":"238","h":"407","rs":Math.PI*2},
         "right":{"url":"../addons/ytao_lipstick/static/img/CircleCenter_3_split_right.png","w":"230","h":"407","cutx":"26","rs":Math.PI*2}},
    ];
    //弹夹剩余子弹数
    ...
    var isup = true;
    //口红资源数组
    var arrayLipstick = ["../addons/ytao_lipstick/static/img/Lipstick_1.png","../addons/ytao_lipstick/static/img/Lipstick_2.png","../addons/ytao_lipstick/static/img/Lipstick_3.png"];
    //中心圆资源数组
    var arrayCenterCircle = ["../addons/ytao_lipstick/static/img/CircleCenter_1.png","../addons/ytao_lipstick/static/img/CircleCenter_2.png","../addons/ytao_lipstick/static/img/CircleCenter_3.png"];
    //关卡资源
    var levelUrl = [
        {"normal":"../addons/ytao_lipstick/static/img/level_icon_1_active.png","active":"../addons/ytao_lipstick/static/img/level_icon_1_active.png"},
        {"normal":"../addons/ytao_lipstick/static/img/level_icon_2.png","active":"../addons/ytao_lipstick/static/img/level_icon_2_active.png"},
        {"normal":"../addons/ytao_lipstick/static/img/level_icon_3.png","active":"../addons/ytao_lipstick/static/img/level_icon_3_active.png"}
    ];
    ...
    CircleCenter.prototype.resetCircleCenterRotate=function (context){
        ...
        if(this.restNum>=10){
            ...
            $("#bulletsNum1").attr("src","../addons/ytao_lipstick/static/img/"+Math.floor(this.restNum/10)+".png")
            $("#bulletsNum2").attr("src","../addons/ytao_lipstick/static/img/"+this.restNum%10+".png")

        }else{
            $("#bulletsNum2").attr("src","")
            $("#bulletsNum2").css("display","none")
            $("#bulletsNum1").attr("src","../addons/ytao_lipstick/static/img/"+this.restNum+".png")
        }
    };
    ...
    Game.prototype = {
        ...
        init:function (){
            ...
            ballimg.src = '../addons/ytao_lipstick/static/img/CircleCenter_1.png';
        ...
        normalResults:function(){
            if(this.bulletCircles[BulletCirclesIndex]){
                this.bulletCircles[BulletCirclesIndex].imgObj.src = "../addons/ytao_lipstick/static/img/Sword_small_"+this.level+"_gray.png";
                BulletCirclesIndex++;
        ...
        nextLevel:function (){
            ...
            if (self.level <= self.levelLength) {
               ...
               $("#levelSwitchBoxMain").attr("src", "../addons/ytao_lipstick/static/img/level_"+self.level+"_mains.jpg");
        ...
        levelChange:function (){
            ...
            for(i = 0; i < lens; i++){
                ...
                tempClipImg.src = "../addons/ytao_lipstick/static/img/Sword_small_"+this.level+".png";
